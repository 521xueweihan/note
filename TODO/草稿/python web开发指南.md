...
- [用 Redis 模拟 session](http://vc2tea.com/redis-session/)
- [简单的理解socket](http://www.cnblogs.com/dolphinX/p/3460545.html)
...
#   Date    :   16/11/12 下午1:23
#   Desc    :   简单的wsgi server实践
...
class WSGIServer(object):
    ...
    def __init__(self, server_address):
        ...
        # Return headers set by Web framework/Web lication
        self.headers_set = []
